        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              FooterDesktopCard(
                backgroundImage:
                    'https://raw.githubusercontent.com/QuyoomTech/ligapayassets/refs/heads/main/lr7.png',
                title: 'Your Instant Global Money Transfer Solution',
                subtitle:
                    'With LigaRemit, transferring money internationally has never been simpler, faster, or more secure.',
                buttonText: 'Join the waiting list',
                onButtonPressed: () {
                  // Handle button press here
                  print("Button Pressed");
...
class DesktopRemittancePage {
  const DesktopRemittancePage();
}
